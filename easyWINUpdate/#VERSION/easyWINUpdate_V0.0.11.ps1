...
<Window
    ...
    Title="easyWINUpdate - Windows Update Management" Height="740" Width="1100" 
    ...
    <Grid>
        ...
        <Border Grid.Row="2" Background="#F0F0F0" BorderBrush="#DDDDDD" BorderThickness="0,1,0,0">
            <Grid Margin="20,0">
                ...
                <StackPanel Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Center">
                    <TextBlock x:Name="versionText" Text="easyWINUpdate v0.0.11" FontStyle="Italic" Foreground="#555555"/>
                </StackPanel>
            </Grid>
        </Border>
    </Grid>
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCIDyfgRi0xGupy
# eEOXWYWlMnrRu9wnSnMi9hdM5MdHvKCCFk4wggMQMIIB+KADAgECAhB3jzsyX9Cg
...
# BgkqhkiG9w0BCQQxIgQg6pD6W3EKcWD/sxDGOro0+fCX2ijp6YgtSwRoYUJF3uUw
# DQYJKoZIhvcNAQEBBQAEggEADuqdlt4LtPzOYgyjTPdhXSyh7tLfL2raJqtLqKKB
# U829BgWXYMuaVTkRd6E9nuzR2phTUpVIxvdBjQnyBcj/Jl9Qw82Vzu9vPdJXBTxu
# h1wMhoWGcH2DHzLR1zYnNouW35lDJVqEiLVZ11PFc2FbFiKJHphwtc0yoxbYUWVd
# 3a4/l5JtJqV8P/l4I4ct65CpfoVqn9U8XXMT6TBQwmVYA8tP4wx3xUl6bIvxESGo
# 1shQDCRQCmu5tGPHD08PfUdzYSB2DGPsdZFVj+obZ1QGxMcfiEgFxhgxkWXiBEwe
# vn5ePyHW+RCHoyBtey6dmVVW3l9RX6YyFYY5m2KRZQROx6GCAyYwggMiBgkqhkiG
...
# SIb3DQEJBTEPFw0yNTA3MTIwODAwMThaMC8GCSqGSIb3DQEJBDEiBCD9ZFvvSBPk
# GrGyl7gHH36kQutVnAw+7vJV3wJev5khTDANBgkqhkiG9w0BAQEFAASCAgCrIHdX
# 7x9mUb6/kiOxaWrtNo06wCzOUzx+1c7NX+bTIUnAOUAdgytONG+yRMHhWPCcrCMR
# cOYEQpdQL9iqjBwhcKFfwT43U/3th4cl8AlQ0Ow8of8mO5gLZOhDGsTZI0SvCc0p
# vI8tWrL61drH5KdCGtDyi9LCoaj4PSscqgfvqpIWalP9ttizck9ndMU1mCOlChbR
# EMdkdhCX2biM7mr0I0mCfFZv4Cmm/gEar6jlmlnqRzLG4dJSzlGqLYqwnrOrLx+z
# oPLjxlzg/xCohV1Z3yDy42iPupWwaXZ1Wm5qBVb+g1Nw1cnb6ROjHRPke5lGqey+
# OoZOrCioa5DLCBvmznVyOKEf+xsWsxUINhmg4yza5q99/GzNRr+ZjuCRJeFKWuld
# FtogsbkShhxTTrmsSjElmiDaM5Yi+Sq6vFpQQEOng6RP2z+c3WIzaf7g/bYcQHez
# WuZB3bMnYWr6V9PN3DCJLYskP3pazmnKJVVZ1jf6b3EUqRWVaDqhJ77s5ibKvjx9
# auGNjrxR5wyItzDySpYoT8fF9gjHD1gUz4mFDoGtBRRY6cLE02lcQ/HZPWY0A1rc
# 49l03nm/r7YrWGMgK1hlvrqCzw35B4EeA9B3axygPMhGyArP2cY/qhqZdA5GtBWl
# NVOYk4M4nbnaoEQA21MbAruGHjrTntcfq8tp5Q==
